...
RequiredModules = @(@{ModuleName = 'Az.Accounts'; ModuleVersion = '2.1.3'; })
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Update ADLS dataplane SDK to 1.2.4-alpha. Changes:https://github.com/Azure/azure-data-lake-store-net/blob/preview-alpha/CHANGELOG.md#version-124-alpha'
