...
```
Set-AzSentinelIncident -Id <String> -ResourceGroupName <String> -WorkspaceName <String>
 ...
 [-OwnerUserPrincipalName <String>] [-Severity <IncidentSeverity>] [-Status <IncidentStatus>]
 [-Title <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Update
```
Set-AzSentinelIncident -Id <String> -ResourceGroupName <String> -WorkspaceName <String> -Incident <IIncident>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api202001.IIncident
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SecurityInsights.Models.Api202001.IIncidentLabel[]
Parameter Sets: UpdateExpanded
Aliases:
