...
online version: https://docs.microsoft.com/en-us/powershell/module/az.securityinsights/new-azsecurityinsightsincidentcomment
schema: 2.0.0
---

# New-AzSecurityInsightsIncidentComment
...
```
New-AzSecurityInsightsIncidentComment -Id <String> -IncidentId <String> -ResourceGroupName <String>
