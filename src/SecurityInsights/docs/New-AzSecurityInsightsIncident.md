...
online version: https://docs.microsoft.com/en-us/powershell/module/az.securityinsights/new-azsecurityinsightsincident
schema: 2.0.0
---

# New-AzSecurityInsightsIncident
...
```
New-AzSecurityInsightsIncident -Id <String> -ResourceGroupName <String> -WorkspaceName <String>
